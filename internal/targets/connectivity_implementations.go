...
func (n *NodeConnectivityTester) Test(ctx context.Context, target *Target) (*ConnectivityResult, error) {
	...
	if pingErr != nil {
		...
		result.Message = fmt.Sprintf("Ping test failed: %v", pingErr)
		return result, nil
	}

	result.PingStatus = "success"
	result.ExtraDetails["ping_time"] = pingResult
	...
	if authErr != nil {
		...
		result.Message = fmt.Sprintf("SSH authentication failed: %v", authErr)
		return result, nil
	}

	result.AuthStatus = "success"
	result.Status = "success"
	result.Message = "Node connectivity test passed"
	result.ExtraDetails["ssh_auth_method"] = authResult
...
func (p *PostgresConnectivityTester) Test(ctx context.Context, target *Target) (*ConnectivityResult, error) {
	...
	if authErr != nil {
		result.Status = "failed"
		result.AuthStatus = "failed"
		result.Message = fmt.Sprintf("PostgreSQL authentication failed: %v", authErr)
		return result, nil
	}

	result.AuthStatus = "success"
	result.Status = "success"
	result.Message = "PostgreSQL connectivity test passed"
	result.ExtraDetails["auth_method"] = authResult
...
func (m *MySQLConnectivityTester) Test(ctx context.Context, target *Target) (*ConnectivityResult, error) {
	...
	if authErr != nil {
		result.Status = "failed"
		result.AuthStatus = "failed"
		result.Message = fmt.Sprintf("MySQL authentication failed: %v", authErr)
		return result, nil
	}

	result.AuthStatus = "success"
	result.Status = "success"
	result.Message = "MySQL connectivity test passed"
	result.ExtraDetails["auth_method"] = authResult
...
func (r *RedisConnectivityTester) Test(ctx context.Context, target *Target) (*ConnectivityResult, error) {
	...
	if authErr != nil {
		result.Status = "failed"
		result.AuthStatus = "failed"
		result.Message = fmt.Sprintf("Redis authentication failed: %v", authErr)
		return result, nil
	}

	result.AuthStatus = "success"
	result.Status = "success"
	result.Message = "Redis connectivity test passed"
	result.ExtraDetails["auth_method"] = authResult
